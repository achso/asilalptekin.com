...
export default function Home() {
  return (
    <div className="min-h-screen w-full flex flex-col">
        ...
        <header className="flex flex-col min-[821px]:flex-row items-stretch justify-between gap-0 divide-y min-[821px]:divide-y-0 min-[821px]:divide-x divide-border">
          <div className="flex flex-col w-full min-[821px]:w-[60%] lg:w-[65%] py-12 min-[821px]:pr-12 lg:pr-16" style={{ position: "relative" }}>
            ...
            <div className="flex flex-wrap gap-x-16 gap-y-6 mt-8 min-[821px]:mt-12">
              <div>
                <p className="hero-subtitle text-foreground">Currently</p>
                <p className="font-[600] text-[20px] lg:text-[24px] text-foreground/40 leading-[38.4px]">SalesOS @ Enpal</p>
              </div>
              <div>
                <p className="hero-subtitle text-foreground">Previously at</p>
                <p className="font-[600] text-[20px] lg:text-[24px] text-foreground/40 leading-[38.4px]">Craft OS, Enpal</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col w-full min-[821px]:w-[40%] lg:w-[35%] items-start py-12 min-[821px]:pl-12 lg:pl-16">
            ...
            <p className="hero-subtitle text-foreground">Nice to meet you!</p>
            <p className="text-[20px] lg:text-[24px] font-[600] text-foreground/40 leading-[38.4px] mb-6 max-w-2xl">
            ...
            <div className="flex items-center gap-5">
              <a
                ...
                aria-label="LinkedIn"
                className="text-[#898989] hover:text-black hover:bg-black/10 transition-all duration-[600ms] w-12 h-12 rounded-full flex items-center justify-center"
              >
      ...
      <footer className="mt-20 px-8 py-8 w-full border-t border-border flex flex-col sm:flex-row items-center justify-between text-xs text-muted-foreground font-medium">
        <p>Current timezone is Pacific Standard Time (PST).</p>
