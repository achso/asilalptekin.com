    ...
    <div id="editable-content" className="min-h-screen w-full flex flex-col">
      ...
      <div className="pt-32 pb-8 px-8 w-full relative overflow-hidden">
        ...
        <header className="flex flex-col min-[821px]:flex-row items-stretch justify-between gap-0 divide-y min-[821px]:divide-y-0 min-[821px]:divide-x divide-border">
          <div className="flex flex-col w-full min-[821px]:w-[60%] lg:w-[65%] py-12 min-[821px]:pr-12 lg:pr-16 overflow-hidden" style={{ position: "relative" }}>
            <motion.div
              initial={{ opacity: 0, y: "100%" }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 1, ease: [0.25, 0.1, 0.25, 1], delay: 0 }}
            >
              <div className="text-[64px] lg:text-[84px] tracking-[-0.02em] leading-[0.85] mb-4">
                <div style={{ position: "relative" }}>
                  {/* Layer 1: Blurred ghost */}
                  <div
                    aria-hidden="true"
                    style={{
                      position: "absolute",
          ...
          <div className="flex flex-col w-full min-[821px]:w-[40%] lg:w-[35%] items-start py-12 min-[821px]:pl-12 lg:pl-16 overflow-hidden">
            <motion.div
              initial={{ opacity: 0, y: "100%" }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 1, ease: [0.25, 0.1, 0.25, 1], delay: 0.23 }}
            >
